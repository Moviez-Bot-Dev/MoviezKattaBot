...
from database.mania_utils import progress_for_pyrogram, humanbytes
...
async def youtube_dl_call_back(client, query):
    ...
    try:
        ...
        xMANIA_BAAPUx_init = await query.edit_message_text(
                        text=f"ღ♡ ɪɴɪᴛɪᴀᴛɪɴɢ ᴍᴀɴɪᴀ ᴄᴏɴꜱᴛʀᴜᴄᴛɪᴏɴ ♡♪ \n⬇️⏬ {namee}",
                    )
        await query.edit_message_text(f"**ღ♡ ʀᴜɴɴɪɴɢ ᴍᴀɴɪᴀ ᴄᴏɴꜱᴛʀᴜᴄᴛɪᴏɴ ♡♪**\n**ᵉⁿʲᵒʸ ˢᵘᵖᵉʳᶠᵃˢᵗ ᵈᵒʷⁿˡᵒᵈ ᵇʸ [ᴍᴀɴɪᴀ](https://t.me/MANIADeveloper)◔_◔** \n\n**░░✩ 📂𝐎𝐑𝐆 𝐅𝐈𝐋𝐄𝐍𝐀𝐌𝐄 ✩ **\n<code>{namee}</code>\n\n**░░✩ 📝𝐍𝐄𝐖 𝐍𝐀𝐌𝐄 ✩ **\n<code>{template_name}</code>\n\n███████████████████████\n⚡️**ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ** | 🧬ѕιzє: {sizee}", disable_web_page_preview=True,)
        # progress to be displayed to the user
        # i am currently work on this to display current progress in progress bar in the chat
        # if you have code then you can contact me @Mania24SupportBot on telegram - instagram 
        # with love 💘 @Mania24SupportBot
    except Exception as e:
        await xMANIA_BAAPUx_init.edit(e)
        pass
    try:
