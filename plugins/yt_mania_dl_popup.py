...
from database.mania_utils import  humanbytes
...
async def echo(client, message):
    ...
    if "youtu" in url or "youtube" in url:
        ...
        xMANIA_BAAPUx_d_size = requests.head(url)    
    ...
    namee = "undefined" if "youtu" in url or "youtube" in url else xMANIA_BAAPUx_u_name
