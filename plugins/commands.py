...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        ...
        await asyncio.sleep(2) # 😢 https://github.com/Moviez-Bot-Dev/MoviezKattaBot/blob/stream-feature/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            logger.error("Hey Dear, check I'm in added in channel/group...!")
            return
        btn = [
            [
...
async def delete(bot, message):
    ...
    if result.deleted_count:
        ...
        if result.deleted_count:
            ...
            # files indexed before https://github.com/Moviez-Bot-Dev/MoviezKattaBot
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('♥️ Thank You Moviez Mania ♥️')
